...
public class RechtlichesView extends VerticalLayout {
	...
	public RechtlichesView(StrainService strainService) {
...
//        layerTwoLayout.setFlexGrow(1, statuteLayout, attorneyLayout, templateLayout);
	...
	private void createMemberPreventionComponent() {
		...
		memberPreventionLayout.add(typeLayout);
	}
